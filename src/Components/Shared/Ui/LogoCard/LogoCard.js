...
class LogoCard extends Component {
  ...
  render() {
    const src = (this.props.src) ? this.props.src : `./img/logo-${this.props.label}.svg`;
    let cssClass = '';
    if (this.props.cssClass) {
      cssClass = classes[`${this.props.cssClass}`];
    }
    ...
    return (
      <div className={`${classes.card} ${cssClass}`}>
        ...
        <ReactImageFallback
          src={{ uri: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADMAAAAzCAYAAAA6oTAqAAAAEXRFWHRTb2Z0d2FyZQBwbmdjcnVzaEB1SfMAAABQSURBVGje7dSxCQBACARB+2/ab8BEeQNhFi6WSYzYLYudDQYGBgYGBgYGBgYGBgYGBgZmcvDqYGBgmhivGQYGBgYGBgYGBgYGBgYGBgbmQw+P/eMrC5UTVAAAAABJRU5ErkJggg==' }}
