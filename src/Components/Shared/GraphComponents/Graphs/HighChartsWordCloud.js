...
export default class HighChartsWordCloud extends Component {
  ...
  componentDidMount() {
    ...
    const r = {};
    localData.forEach((o) => {
      if (!(o.name_normalized in ['none', '--', '.'] || o.name_normalized.includes('mot-cle') || o.name_normalized.includes('no keyword') || o.name_normalized.includes('non precise') || o.name_normalized.includes('danshal') || (o.name_normalized.length < 4))) {
        r[o.name_normalized] = {
