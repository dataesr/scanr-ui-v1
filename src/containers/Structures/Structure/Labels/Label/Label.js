...
class Label extends Component{
  ...
  render(){
    ...
    if(this.state.index === 0){
      if(this.props.n_labels > 1){
        bt_show_all = <button onClick={this.props.toggleLabelsButton}
                              className={` button is-light  ${classes.space_5}`}>
                        {this.props.showAll ? <i className="fas fa-eye-slash"></i>:<i className="fas fa-eye"></i>}
                      </button>;
      }
