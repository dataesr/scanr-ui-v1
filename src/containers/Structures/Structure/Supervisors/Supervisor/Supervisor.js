...
class Supervisor extends Component{
  ...
  render(){
    ...
    if(this.state.mode === 'modify'){
      ...
      code_number = <input type="text"
                     className="input is-rounded"
                     value={code_number || ''}
                     id="value"
                     onChange={this.changeInputHandler}/>;

                   supervision_type = <input type="text"
                     className="input is-rounded"
