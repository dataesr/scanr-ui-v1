  ...
  render(){
    ...
    if(this.state.mode === 'modify'){
      ...
      value = <input type="text"
                   ...
                   succession_type = <input type="text"
                     className="input is-rounded"
                     value={succession_type || ''}
                     id="succession_type"
                     onChange={this.changeInputHandler}/>;

      date_effect = <input type="text"
                     className="input is-rounded"
                     value={date_effect || ''}
                     id="date_effect"
                     onChange={this.changeInputHandler}/>;
