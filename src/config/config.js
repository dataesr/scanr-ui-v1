...
// Search
export const API_STRUCTURES_SEARCH_END_POINT = 'https://scanr-preprod.sword-group.com/api/v2/structures/search';
...
// Patents
export const EP = ['AL', 'AT', 'BA', 'BE', 'BG', 'CH', 'CY', 'CZ', 'DE', 'DK', 'EE', 'ES', 'FI', 'FR', 'GB', 'GR', 'HR', 'HU', 'IE', 'IS', 'IT', 'LI', 'LT', 'LU', 'LV', 'MC', 'ME', 'MK', 'MT', 'NL', 'NO', 'PL', 'PT', 'RO', 'RS', 'SE', 'SI', 'SK', 'SM', 'TR'];
...
// FAQ
export const GROUPKEY_ORDERED = ['general', 'search', 'entities', 'persons', 'prizes', 'projects', 'productions', 'publications', 'patent'];
